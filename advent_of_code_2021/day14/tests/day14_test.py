...
from advent_of_code_2021.day14.main import apply_rules
from advent_of_code_2021.day14.main import evaluate_counts
from advent_of_code_2021.day14.main import evaluate_counts_part_two
from advent_of_code_2021.day14.main import get_character_counts
from advent_of_code_2021.day14.main import get_distinct_characters
from advent_of_code_2021.day14.main import get_pairs_from_polymer
...
def test_day_14_read_input(sample_data: tuple[str, dict[str, str]]) -> None:
    assert read_input(CURRENT_DIRECTORY / "sample_input.txt") == sample_data
