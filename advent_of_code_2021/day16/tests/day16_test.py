...
from advent_of_code_2021.day16.main import convert_hex_to_binary
from advent_of_code_2021.day16.main import get_literal_value
from advent_of_code_2021.day16.main import parse_packets
from advent_of_code_2021.day16.main import part_one
...
def test_day_16_read_input() -> None:
    binary_data = read_input(CURRENT_DIRECTORY / "sample_input.txt")
    assert binary_data == "110100101111111000101000"


def test_day_16_read_input2() -> None:
    binary_data = read_input(CURRENT_DIRECTORY / "sample_input2.txt")
...
def test_day_16_parse_more_packets() -> None:
    binary_data = read_input(CURRENT_DIRECTORY / "sample_input3.txt")
    packets, _ = parse_packets(binary_data)
...
def test_day_16_part_one() -> None:
    binary_data = read_input(CURRENT_DIRECTORY / "sample_input4.txt")
    result = part_one(binary_data)
    assert result == 16

    binary_data = read_input(CURRENT_DIRECTORY / "sample_input5.txt")
    result = part_one(binary_data)
    assert result == 12

    binary_data = read_input(CURRENT_DIRECTORY / "sample_input6.txt")
    result = part_one(binary_data)
    assert result == 23

    binary_data = read_input(CURRENT_DIRECTORY / "sample_input7.txt")
    result = part_one(binary_data)
    assert result == 31
